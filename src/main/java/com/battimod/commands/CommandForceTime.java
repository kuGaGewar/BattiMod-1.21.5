...
public class CommandForceTime {
    public static void register() {
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> {
            dispatcher.register(CommandManager.literal("forcetime")
                    .then(CommandManager.argument("sekunden", IntegerArgumentType.integer(10, 3600))
